...
class AllegroHandBlindGrasp(BaseTask):
    def __init__(self, cfg, sim_params, physics_engine, device_type, device_id, headless,
        ...
        # TODO change num_obs to be allegro hand specific
        num_obs = 126 
        self.num_obs_dict = {
            "full_state": num_obs
        }
        self.num_hand_obs = 126 

        self.up_axis = 'z'
        # TODO: change the fingertip names to be allegro hand specific
        # self.fingertips = ["robot0:ffdistal", "robot0:mfdistal", "robot0:rfdistal", "robot0:lfdistal",
        #                    "robot0:thdistal"]
        self.fingertips = ["index_link_3", "middle_link_3", "ring_link_3", "thumb_link_3"]
        ...
        # print("actor_root_state_tensor:", actor_root_state_tensor.shape)
        # print("dof_state_tensor:", dof_state_tensor.shape)
        # print("rigid_body_tensor:", rigid_body_tensor.shape)
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        # shadow_hand_asset_file = "urdf/drake/allegro_hand_description/urdf/allegro_hand_description_left.urdf"
        ...
        # for allegro hand
        # for fixed joint, isaac gym treat them as one rigid body
        body_names = {
            'palm': 'allegro_mount',
            'thumb': 'thumb_link_3',
            'index': 'index_link_3',
        ...
        # show all the names for the rigid bodies
        print(self.gym.get_asset_rigid_body_names(shadow_hand_asset))
    ...
    def compute_full_state(self, asymm_obs=False):
        ...
        # unscale to (-1，1)
        num_ft_states = 13 * int(self.num_fingertips)  # 4* 13 = 52
        num_ft_force_torques = 6 * int(self.num_fingertips)  # 4* 6 = 24
        ...
        # print(self.fingertip_state.shape)
        # exit()
        ...
        self.obs_buf[:, now_position:now_position + 22] = aux
        now_position += 22
    ...
    def pre_physics_step(self, actions):
        ...
        if self.use_relative_control:
            ...
            # seems should be applied to 0, which is the fixed joint of amount and palm
        ...
        flag = self.gym.set_dof_position_target_tensor_indexed(self.sim,
                                                        gymtorch.unwrap_tensor(self.prev_targets),
                                                        gymtorch.unwrap_tensor(all_hand_indices), len(all_hand_indices))
        # print(all_hand_indices)
        # exit()

        # print("self.prev_targets.shape", self.prev_targets.shape)
        # print("all_hand_indices.shape", all_hand_indices.shape)
        # exit()
...
def compute_hand_reward(
    ...
    if goal_cond:
        ...
        reward = torch.zeros_like(right_hand_finger_dist)
