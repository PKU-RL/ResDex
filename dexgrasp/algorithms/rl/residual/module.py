...
class ActorCritic(nn.Module):
    ...
    def __init__(self, obs_shape, states_shape, actions_shape, initial_std, model_cfg,
                  asymmetric=False, use_pc = False, type="base"):
        ...
        #     self.actor = nn.Sequential(*actor_layers)
        # elif type == "residual":
        #     self.actor = nn.Sequential(*actor_layers, nn.Tanh())
        self.actor = nn.Sequential(*actor_layers)
    ...
    def init_weights(sequential, scales):
        ...
        # [torch.nn.init.constant_(module.weight, 0) for module in sequential if isinstance(module, nn.Linear)]
